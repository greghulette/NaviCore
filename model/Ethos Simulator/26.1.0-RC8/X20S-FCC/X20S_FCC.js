...
function findWasmBinary() {
    return locateFile('X20S_FCC.wasm');
}
...
var ASM_CONSTS = {
  12153856: () => { FS.syncfs(false, function (err) { ccall('onSyncFsDone', 'void', [], []); if (err) { console.error("Sync to IndexedDB failed:", err) } else if (Module.syncToLocal) { Module.syncToLocal() } }) },  
 12154051: ($0) => { Module.setSwitchesConfig && Module.setSwitchesConfig($0) },  
 12154112: ($0, $1) => { Module.setSwitchesPosition && Module.setSwitchesPosition($0, $1) },  
 12154181: ($0, $1) => { Module.setFunctionSwitchesState && Module.setFunctionSwitchesState($0, $1) },  
 12154260: ($0, $1) => { Module.setTrimsValue && Module.setTrimsValue($0, $1) },  
 12154317: ($0, $1) => { Module.audioPushBuffer && Module.audioPushBuffer($0, $1) },  
 12154378: ($0, $1, $2) => { Module.updateCanvas && Module.updateCanvas($0, $1, $2) },  
 12154437: ($0, $1, $2) => { Module.updateCanvasGlasses && Module.updateCanvasGlasses($0, $1, $2) },  
 12154510: ($0, $1) => { Module.onDebugEvent && Module.onDebugEvent(UTF8ToString($0), $1) },  
 12154579: ($0, $1) => { Module.setModelJson && Module.setModelJson(UTF8ToString($0, $1)) },  
 12154648: ($0, $1) => { Module.onRecordEvent && Module.onRecordEvent(UTF8ToString($0), $1) },  
 12154719: () => { Module.onMacroEnd && Module.onMacroEnd() }
};
var wasmImports;
...
var _onMouseWheel = Module['_onMouseWheel'] = createExportWrapper('onMouseWheel', 1);
var _setFunctionSwitchPressed = Module['_setFunctionSwitchPressed'] = createExportWrapper('setFunctionSwitchPressed', 2);
var _setAnalogPosition = Module['_setAnalogPosition'] = createExportWrapper('setAnalogPosition', 2);
var _setSwitchPosition = Module['_setSwitchPosition'] = createExportWrapper('setSwitchPosition', 2);
var _onSyncFsDone = Module['_onSyncFsDone'] = createExportWrapper('onSyncFsDone', 0);
var _onMouseDown = Module['_onMouseDown'] = createExportWrapper('onMouseDown', 2);
var _onMouseUp = Module['_onMouseUp'] = createExportWrapper('onMouseUp', 2);
var _onMouseMove = Module['_onMouseMove'] = createExportWrapper('onMouseMove', 2);
var _onMouseLongPress = Module['_onMouseLongPress'] = createExportWrapper('onMouseLongPress', 0);
var _setTrimPressed = Module['_setTrimPressed'] = createExportWrapper('setTrimPressed', 2);
var _onKeyEvent = Module['_onKeyEvent'] = createExportWrapper('onKeyEvent', 4);
var _setModelJsonNeeded = Module['_setModelJsonNeeded'] = createExportWrapper('setModelJsonNeeded', 1);
...
var _reloadScripts = Module['_reloadScripts'] = createExportWrapper('reloadScripts', 0);
var _startMacro = Module['_startMacro'] = createExportWrapper('startMacro', 1);
var _stopMacro = Module['_stopMacro'] = createExportWrapper('stopMacro', 0);
var _pauseMacro = Module['_pauseMacro'] = createExportWrapper('pauseMacro', 0);
var _resumeMacro = Module['_resumeMacro'] = createExportWrapper('resumeMacro', 0);
var _stepMacro = Module['_stepMacro'] = createExportWrapper('stepMacro', 0);
var _setBreakpoints = Module['_setBreakpoints'] = createExportWrapper('setBreakpoints', 1);
var _startRecord = Module['_startRecord'] = createExportWrapper('startRecord', 0);
var _stopRecord = Module['_stopRecord'] = createExportWrapper('stopRecord', 0);
var _injectSPortFrame = Module['_injectSPortFrame'] = createExportWrapper('injectSPortFrame', 7);
var _getCurrentModel = Module['_getCurrentModel'] = createExportWrapper('getCurrentModel', 0);
var _writeDefaultSettingsAndModel = Module['_writeDefaultSettingsAndModel'] = createExportWrapper('writeDefaultSettingsAndModel', 0);
var _setLanguage = Module['_setLanguage'] = createExportWrapper('setLanguage', 1);
var _fflush = createExportWrapper('fflush', 1);
var _loadCustomTranslations = Module['_loadCustomTranslations'] = createExportWrapper('loadCustomTranslations', 1);
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 12112532;
...
(() => {
  // Create a small, never-async wrapper around X20S_FCC which
  // checks for callers incorrectly using it with `new`.
  var real_X20S_FCC = X20S_FCC;
  X20S_FCC = function(arg) {
    if (new.target) throw new Error("X20S_FCC() should not be called with `new X20S_FCC()`");
    return real_X20S_FCC(arg);
  }
})();
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = X20S_FCC;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = X20S_FCC;

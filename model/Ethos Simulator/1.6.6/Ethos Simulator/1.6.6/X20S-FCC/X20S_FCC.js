...
var ASM_CONSTS = {
  8485128: () => { FS.syncfs(false, function (err) { ccall('onSyncFsDone', 'void', [], []); if (err) { console.error("Sync to IndexedDB failed:", err) } else if (Module.syncToLocal) { Module.syncToLocal() } }) },  
 8485323: ($0) => { Module.setSwitchesConfig && Module.setSwitchesConfig($0) },  
 8485384: ($0, $1) => { Module.setSwitchesPosition && Module.setSwitchesPosition($0, $1) },  
 8485453: ($0, $1) => { Module.setFunctionSwitchesState && Module.setFunctionSwitchesState($0, $1) },  
 8485532: ($0, $1) => { Module.setTrimsValue && Module.setTrimsValue($0, $1) },  
 8485589: ($0, $1) => { Module.audioPushBuffer && Module.audioPushBuffer($0, $1) },  
 8485650: ($0, $1, $2) => { Module.updateCanvas && Module.updateCanvas($0, $1, $2) }
};
